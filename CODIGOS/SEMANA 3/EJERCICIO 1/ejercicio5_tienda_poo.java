...
public class EJERCICIO5_TIENDA_POO extends javax.swing.JFrame {

    private Tienda tienda;

    public EJERCICIO5_TIENDA_POO() {
        initComponents();
        formulario();
    ...
    private void formulario() {
        this.setTitle("Sistema de Descuentos POO - Tienda");
    ...
    void ingresarDatos() {
        double precio = Double.parseDouble(txtPrecioDocena.getText());
        int cantidad = Integer.parseInt(txtCantidadDocenas.getText());
        tienda.setPrecioDocena(precio);
        tienda.setCantidadDocenas(cantidad);
    }
    ...
    void mostrarResultados() {
        ...
        imprimir("");
        imprimir("Precio por docena : S/. " + String.format("%.2f", tienda.getPrecioDocena()));
        imprimir("Cantidad de docenas : " + tienda.getCantidadDocenas());
        imprimir("");
        imprimir("Importe de la compra : S/. " + String.format("%.2f", tienda.calcularImporteCompra()));
        imprimir("Importe del descuento : S/. " + String.format("%.2f", tienda.calcularDescuento()));
        imprimir("Importe a pagar : S/. " + String.format("%.2f", tienda.calcularImportePagar()));
        imprimir("");
        if (tienda.calcularLapiceros() > 0) {
            imprimir("Lapiceros de obsequio : " + tienda.calcularLapiceros() + " unidades");
        } else {
            imprimir("Lapiceros de obsequio : No hay obsequio");
        }
        imprimir("");
        if (tienda.getCantidadDocenas() >= 10) {
...
class Tienda {
    ...
    public Tienda(double precioDocena, int cantidadDocenas) {
    ...
    public double calcularDescuento() {
        ...
        if (cantidadDocenas >= 10) {
            return 0.20 * importeCompra;
        } else {
            return 0.10 * importeCompra;
        }
    }
