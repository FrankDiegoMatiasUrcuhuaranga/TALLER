...
public class UsuarioDAO {
    ...
    public List<String> getCodigosAdmins() throws SQLException {
        List<String> codigos = new ArrayList<>();
        Connection conn = null; PreparedStatement stmt = null; ResultSet rs = null;
        try {
            conn = Conexion.getConnection();
            // Buscamos todos los usuarios con rol 'admin'
            String sql = "SELECT codigo FROM usuarios WHERE rol = 'admin'";
