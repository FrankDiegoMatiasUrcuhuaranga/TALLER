...
public class TramiteServlet extends HttpServlet {
        ...
        try {
            ...
            if (tramite == null) {
                ...
                if (tramite != null) {
                    ...
                    // Opcional: Notificar admin de nuevo trámite
                    // notificacionService.notificarAdministradores("Nuevo trámite de titulación iniciado por " + usuario.getNombreCompleto());
                }
            }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String codigoEstudiante = usuario.getCodigo();
        String nombreEstudiante = usuario.getNombreCompleto(); // Obtenemos el nombre para el mensaje
        ...
        try {
            ...
            if (subido) {
                // 1. Notificar al alumno (Confirmación)
                notificacionService.notificarDocumentoRecibido(codigoEstudiante, tipoDoc);
                
                // 2. --- NUEVO: Notificar a los Administradores ---
                String msgAdmin = "El estudiante " + nombreEstudiante + " (" + codigoEstudiante + ") ha subido el documento: " + tipoDoc;
