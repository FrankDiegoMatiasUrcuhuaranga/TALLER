    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (exito) {
                ...
                String msgAdmin = "El Asesor " + usuario.getNombreCompleto() + " ha evaluado la Tesis #" + idTesis + ". Resultado: " + condicion;
                notificacionService.notificarAdministradores(msgAdmin);
                
                // (Opcional) Notificar también al Alumno
                // Recuperar código alumno desde TesisDAO si se desea (para una futura mejora)
